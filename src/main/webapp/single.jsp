...
<script type="text/javascript">
	$(function(){
        ...
        $(".Numinput input").keydown(function(event){
			...
			if (!isNaN(num)) {
				if (num > storeNum) {
					confirm("很抱歉，仓库中没有足够数量的化妆品，我们会尽快添加(⊙o⊙)哦！");
					return;
				};
        	};
		});
		...
		$("#addToCart").click(function(){
			...
			if(hasThisProduct){
				if(confirm("该化妆品已在购物车中,点击确定去购物车查看")){
							...
							<div id="products_example">
								<div id="products">
									<div class="slides_container">
									        <a href="#"><img class="a" id="img1" src="${requestScope.product.productImagePath}" alt="" rel="images/s-img10.jpg" /></a>
									</div>
								</div>
							</div>
						</div>
...
<script type="text/javascript" src="js/jquery.flexisel.js"></script>
     ...
     <div class="toogle">
     	...
     	<h3 class="m_3">化妆品销量：${requestScope.product.sales==null?'0':requestScope.product.sales} 件</h3>
     </div>
     <div class="toogle">
     	<h3 class="m_3">评论</h3>
<%--商品评论开始--%>
